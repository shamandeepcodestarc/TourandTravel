...
import './DealDcanclationPolicy.css'
...
function DealDcanclationPolicy() {
  ...
  axios.post(`${common.api_url}dealPolicy`, payload, config)
      .then(res => {
        if (res.data.data) {
          getData();
          toggle3(false)
  ...
  return (
    <Fragment>
                      ...
                      <tbody key={index}>
                        <tr>
                          ...
                          <td>  <FontAwesomeIcon
                            ...
                            onClick={() => GetDealPolciyById(data.id)}
                            id="tooltipforedit"
                            outline={data.id} />
                            <UncontrolledTooltip
                              placement="top"
      ...
      <Modal className="custom_model_size" zIndex={2000} centered scrollable isOpen={modal2} size="lg" toggle={toggle2}>
        <ModalHeader toggle={toggle2}>Information OfDeal Cancellation Policy</ModalHeader>
      ...
      <Modal zIndex={2000} centered size="sm" isOpen={modal4} toggle={toggle4}>
        <ModalHeader toggle={toggle4}>Delete Deal Cancellation Policy</ModalHeader>
        <ModalBody>
      ...
      <Modal zIndex={2000} centered className="custom_model_size" isOpen={modal3} toggle={toggle3} backdrop="static" keyboard={false}>
        <ModalHeader toggle={toggle3}>Add Deal cancellation polciy</ModalHeader>
        <ModalBody>
          <Form>
            <FormGroup row>
              <Label htmlFor="personCapacity" sm={1}>Deal canclation Policy</Label>
              <Col sm={9}>
                <Input
                  type="textarea"
                  id="placeName"
...
export default DealDcanclationPolicy;
